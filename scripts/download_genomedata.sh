...
if test $build = "GRCh38" -o $build = "hg38"; then
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/homo_sapiens/Homo_sapiens.GRCh38.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/homo_sapiens/Homo_sapiens.GRCh38.$Ensembl_version.chr.gff3.gz"
...
#    ex "wget --timestamping http://ftp.ebi.ac.uk/pub/databases/gencode/Gencode_human/release_40/gencode.v40.annotation.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh38.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/homo_sapiens/ncrna/Homo_sapiens.GRCh38.ncrna.fa.gz"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/grch37/release-$Ensembl_version/gtf/homo_sapiens/Homo_sapiens.GRCh37.87.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/grch37/release-$Ensembl_version/gff3/homo_sapiens/Homo_sapiens.GRCh37.87.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/grch37/release-$Ensembl_version/fasta/homo_sapiens/cdna/Homo_sapiens.GRCh37.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/grch37/release-$Ensembl_version/fasta/homo_sapiens/ncrna/Homo_sapiens.GRCh37.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/mus_musculus/Mus_musculus.GRCm39.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/mus_musculus/Mus_musculus.GRCm39.$Ensembl_version.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/mus_musculus/cdna/Mus_musculus.GRCm39.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/mus_musculus/ncrna/Mus_musculus.GRCm39.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    chrs="$(seq 1 19) X Y M"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/rattus_norvegicus/Rattus_norvegicus.mRatBN7.2.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/rattus_norvegicus/Rattus_norvegicus.mRatBN7.2.$Ensembl_version.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/rattus_norvegicus/cdna/Rattus_norvegicus.mRatBN7.2.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/rattus_norvegicus/ncrna/Rattus_norvegicus.mRatBN7.2.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    chrs="$(seq 1 20) X Y M"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/danio_rerio/Danio_rerio.GRCz11.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/danio_rerio/Danio_rerio.GRCz11.$Ensembl_version.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/danio_rerio/cdna/Danio_rerio.GRCz11.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/danio_rerio/ncrna/Danio_rerio.GRCz11.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    chrs="$(seq 1 25) M"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/gallus_gallus/Gallus_gallus.GRCg6a.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/gallus_gallus/Gallus_gallus.GRCg6a.$Ensembl_version.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/gallus_gallus/cdna/Gallus_gallus.GRCg6a.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/gallus_gallus/ncrna/Gallus_gallus.GRCg6a.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/xenopus_tropicalis/Xenopus_tropicalis.Xenopus_tropicalis_v9.1.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/xenopus_tropicalis/Xenopus_tropicalis.Xenopus_tropicalis_v9.1.$Ensembl_version.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/xenopus_tropicalis/cdna/Xenopus_tropicalis.Xenopus_tropicalis_v9.1.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/xenopus_tropicalis/ncrna/Xenopus_tropicalis.Xenopus_tropicalis_v9.1.ncrna.fa.gz"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/drosophila_melanogaster/Drosophila_melanogaster.BDGP6.32.$Ensembl_version.chr.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/drosophila_melanogaster/Drosophila_melanogaster.BDGP6.32.$Ensembl_version.chr.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/drosophila_melanogaster/cdna/Drosophila_melanogaster.BDGP6.32.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/drosophila_melanogaster/ncrna/Drosophila_melanogaster.BDGP6.32.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/caenorhabditis_elegans/Caenorhabditis_elegans.WBcel235.$Ensembl_version.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/caenorhabditis_elegans/Caenorhabditis_elegans.WBcel235.$Ensembl_version.gff3.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/caenorhabditis_elegans/cdna/Caenorhabditis_elegans.WBcel235.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/caenorhabditis_elegans/ncrna/Caenorhabditis_elegans.WBcel235.ncrna.fa.gz"
    ex "unpigz -f *gtf.gz *gff3.gz"
    ...
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gtf/saccharomyces_cerevisiae/Saccharomyces_cerevisiae.R64-1-1.$Ensembl_version.gtf.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/gff3/saccharomyces_cerevisiae/Saccharomyces_cerevisiae.R64-1-1.$Ensembl_version.gff3.gz"
    ex "wget --timestamping https://sgd-prod-upload.s3.amazonaws.com/S000212118/SGD_features.tab.20110827.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/saccharomyces_cerevisiae/cdna/Saccharomyces_cerevisiae.R64-1-1.cdna.all.fa.gz"
    ex "wget --timestamping http://ftp.ensembl.org/pub/release-$Ensembl_version/fasta/saccharomyces_cerevisiae/ncrna/Saccharomyces_cerevisiae.R64-1-1.ncrna.fa.gz"
